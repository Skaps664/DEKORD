      ...
      <div className="max-w-md mx-auto">
        ...
        >
          ...
          <div className="p-6">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-neutral-900 text-white py-2.5 rounded-lg font-medium hover:bg-neutral-800 transition-colors shadow-lg hover:shadow-xl"
                >
            ...
            <button
              type="button"
              className="w-full flex items-center justify-center gap-2 px-4 py-2.5 border border-neutral-300 rounded-lg hover:bg-neutral-50 transition-colors"
            >
